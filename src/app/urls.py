...
from app.views import top, sandbox, sandbox_chat, sandbox_chat_log_detail, upload_image
...
urlpatterns = [
    ...
    path("sandbox_chat/<str:room_name>/", login_required(sandbox_chat_log_detail), name="sandbox_chat_log_detail"),
